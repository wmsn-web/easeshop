...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%; background-color: #000; padding-left: 95px; padding-right: 95px">
	<div align="center">
		<div style="width:60%; padding: 15px; background: #fff; margin-top: 25px">
...
<span style="color: #ff0000;"><span style="font-size: 46px;"><span style="color: #ff0000; font-size: 28px;"><strong>Order has been placed</strong>
</p>
</div>
</div>
...
<table style="width:100%">
	<tr>
		<th style="border:solid 1px #f2f2f2; padding: 6px; width: 20% ">Image</th>
		<th style="border:solid 1px #f2f2f2; padding: 6px; width: 40% ">Product Details</th>
		<th style="border:solid 1px #f2f2f2; padding: 6px; width: 20% ">QTY</th>
		<th style="border:solid 1px #f2f2f2; padding: 6px; width: 20% ">Price</th>
	</tr>
	<?php if(!empty($mailData['cartData'])): ?>
	...
	<tr>
		...
		<td></td>
		<td></td>
		<td style="border:solid 1px #f2f2f2; padding: 6px; text-align: center;"  ><b>Total:</b></td>
		<td style="border:solid 1px #f2f2f2; padding: 6px; text-align: right;  "><b><?= $mailData['datas']; ?></b></td>
	</tr>
</table>
</p>
</div>
...
<span style="font-size: 16px;">We will notify you on next Update. Thank you for shopping from us. </span>
</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
